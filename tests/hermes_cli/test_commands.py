...
class TestPluginCommandEnumeration:
    ...
    def test_should_bypass_active_session_recognizes_plugin_commands(self, monkeypatch):
        """Plugin commands must bypass adapter-level active-session queuing."""
        ...
        assert should_bypass_active_session("metricas") is True
        assert should_bypass_active_session("definitely-not-registered") is False
