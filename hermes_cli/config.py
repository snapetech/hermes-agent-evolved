...
DEFAULT_CONFIG = {
    ...
    # Gateway channel profiles — per-channel overlays for model, reasoning,
    # tools, prompt, and session isolation. Keys are platform values, then
    # platform chat/channel IDs. Example:
    # gateway:
    #   channel_profiles:
    #     discord:
    #       "123456789012345678":
    ...
    #         db_namespace: hermes_sue
    #         memory_namespace: hermes_sue
    #         model:
    #           provider: anthropic
    ...
    #           This channel is for thoughtful discussion and research.
    "gateway": {
        "channel_profiles": {},
    },
